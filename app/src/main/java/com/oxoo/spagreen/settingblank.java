...
public class settingblank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_settingblank);
        ...
        switcDarkMode.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                startActivity(new Intent(settingblank.this,SplashscreenActivity.class));
                finish();
            }
        });
        ...
        tvTerms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(settingblank.this,TermsActivity.class));
            }
        });
